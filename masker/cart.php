...
if(isset($_POST['form1'])) {
    ...
    for($i=1;$i<=count($arr1);$i++) {
        ...
        if($table_quantity[$temp_index] < $arr2[$i]) {
        	$allow_update = 0;
            $error_message .= '"'.$arr2[$i].'" tidak ada produk"'.$arr3[$i].'"\n';
        } else {
	...
	<?php else: ?>
		<script>alert('Keranjang sudah di update');</script>
	<?php endif; ?>
    <?php
			...
			<div class="col-md-12">
				...
				<div class="cart">
                    <table class="table table-responsive">
                        ...
                        <tr>
                            ...
                            <th class="total-amount"><?php echo LANG_VALUE_1; ?><?php echo $table_total_price; ?><?php echo ".000"?></th>
                            <th></th>
                        </tr>
                    </table> 
                </div>
                ...
                <div class="cart-buttons">
                    <ul>
                        ...
                        <li><a href="index.php" class="btn btn-primary"><?php echo "Kembali Belanja"; ?></a></li>
                        <li><a href="checkout.php" class="btn btn-primary"><?php echo "Checkout produk"; ?></a></li>
                    </ul>
                </div>
                </form>
                <?php endif; ?>

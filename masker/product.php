...
if(isset($_POST['form_add_to_cart'])) {
    ...
    if(isset($_SESSION['cart_p_id']))
    {
        ...
        if($added == 1) {
           $error_message1 = 'This product is already added to the shopping cart.';
            ...
            $_SESSION['cart_p_featured_photo'][$new_key] = $_POST['foto'];
    ...
    {     
        ...
        $_SESSION['cart_p_featured_photo'][1] = $_POST['foto'];
					...
					<div class="row">
						...
						<div class="col-md-7">
							...
							<div class="p-price">
                                ...
                                <span>
                                    <?php if($p_old_price!=''): ?>
                                        <del>Rp.<?php echo $p_old_price; ?></del>
                                    <?php endif; ?> 
                                        Rp.<?php echo $p_current_price; ?>
                                </span>
                            </div>
                            <input type="hidden" name="p_current_price" value="<?php echo $p_current_price; ?>">
                            <input type="hidden" name="p_name" value="<?php echo $p_name; ?>">
                            <input type="hidden" name="foto" value="<?php echo $p_featured_photo; ?>">
							<div class="p-quantity">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation" class="active"><a href="#description" aria-controls="description" role="tab" data-toggle="tab"><?php echo ("Cara pemakaian produk"); ?></a></li>
								<li role="presentation"><a href="#feature" aria-controls="feature" role="tab" data-toggle="tab"><?php echo ("Bahan produk") ?></a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            <div class="thumb">
                                <div class="photo" style="background-image:url(assets/uploads/<?php echo $row['foto']; ?>);"></div>

...
ProduNamect : '.$row['product_name'].'<br>
            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
	                    ...
	                    <td>
                            ...
                            <b>Nama:</b><br> <?php echo $row['customer_name']; ?><br>
                        ...
                        <td>
                           ...
                           foreach ($result1 as $row1) {
                                echo '<b>Produk:</b> '.$row1['product_name'];
                                echo '<br>(<b>Jumlah:</b> '.$row1['quantity'];
                                echo ', <b>Unit Harga:</b> '.$row1['unit_price'].')';
                                echo '<br><br>';
                           }
                           ?>
                        </td>
                        <td>
                        	<?php if($row['payment_method'] == 'PayPal'): ?>
                        		<b>Pembayaran :</b> <?php echo '<span style="color:red;"><b>'.$row['payment_method'].'</b></span>'; ?><br>
                        		<b>Id Pembayaran:</b> <?php echo $row['payment_id']; ?><br>
                        		<b>Tanggal :</b> <?php echo $row['payment_date']; ?><br>
                        		<b>Transaksi id:</b> <?php echo $row['txnid']; ?><br>
                        	<?php elseif($row['payment_method'] == 'Stripe'): ?>
                        		<b>Pembayaran :</b> <?php echo '<span style="color:red;"><b>'.$row['payment_method'].'</b></span>'; ?><br>
                        		<b>Id Pembayaran:</b> <?php echo $row['payment_id']; ?><br>
								<b>Tanggal :</b> <?php echo $row['payment_date']; ?><br>
                        		<b>Transaksi Id:</b> <?php echo $row['txnid']; ?><br>
                        		<b>No card:</b> <?php echo $row['card_number']; ?><br>
                        	...
                        	<?php elseif($row['payment_method'] == 'Bank Deposit'): ?>
                        		...
                        		<b>Id Pembayaran : </b> <?php echo $row['payment_id']; ?><br>
								<b>Tanggal :</b> <?php echo $row['payment_date']; ?><br>
                        		<b>Informasi:</b> <br><?php echo $row['bank_transaction_info']; ?><br>
                        	<?php endif; ?>
                        </td>
                        <td><?php echo $row['paid_amount']; ?><?php echo ".000"; ?></td>
                        <td>

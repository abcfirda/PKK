        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_5" data-toggle="tab">Produk</a></li>
                        ...
                        <div class="tab-pane" id="tab_7">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Login</h4>
                                        Pilih Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="ubah" style="margin-top:10px;" name="form7_1">
                                    </td>
                                    </form>
                                </tr>
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Registrasi</h4>
                                        <p>
                                    ...
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Registrasi</h4>
                                        Pilih Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="ubah" style="margin-top:10px;" name="form7_2">
                                    </td>
                                    </form>
                                </tr>
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Password</h4>
                                        <p>
                                    ...
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Password</h4>
                                        Pilih Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="ubah" style="margin-top:10px;" name="form7_3">
                                    </td>
                                    </form>
                                </tr>
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Reset Password</h4>
                                        <p>
                                    ...
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Reset Password</h4>
                                        Pilih Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="ubah" style="margin-top:10px;" name="form7_4">
                                    </td>
                                    </form>
                                </tr>
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Pencarian</h4>
                                        <p>
                                    ...
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Pencarian</h4>
                                        Pilih Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="ubah" style="margin-top:10px;" name="form7_6">
                                    </td>
                                    </form>
                                </tr>
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Keranjang</h4>
                                        <p>
                                    ...
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Keranjang</h4>
                                        Pilih Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="ubah" style="margin-top:10px;" name="form7_7">
                                    </td>
                                    </form>
                                </tr>
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Checkout</h4>
                                        <p>
                                    ...
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Checkout</h4>
                                        Pilih Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="ubah" style="margin-top:10px;" name="form7_8">
                                    </td>
                                    </form>
                                </tr>
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Produk Kategori</h4>
                                        <p>
                                    ...
                                    <td style="width:50%">
                                        <h4>Ubah Banner Halaman Produk Kategori</h4>
                                        Pilih Foto<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="ubah" style="margin-top:10px;" name="form7_9">
                                    </td>
                                    </form>
                                </tr>

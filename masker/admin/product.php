					...
					<table id="example1" class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<th width="60">Harga awal</th>
								<th width="60">Harga diskon</th>
								<th width="60">Stok</th>
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									<td><?php echo $i; ?></td>
									<td style="width:130px;"><img src="../assets/uploads/<?php echo $row['foto']; ?>" alt="<?php echo $row['p_name']; ?>" style="width:100px;"></td>
									<td><?php echo $row['p_name']; ?></td>
									<td><?php echo $row['p_old_price']; ?></td>
									<td><?php echo $row['p_current_price']; ?></td>
									<td><?php echo $row['p_qty']; ?></td>
									<td>
										<?php if($row['foto'] == 1) {echo 'Yes';} else {echo 'No';} ?>
									</td>
									<td>

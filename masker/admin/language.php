...
if(isset($_POST['form1'])) {
	...
	$success_message = 'Berhasil Mengubahnya.';
}
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <h3 style="font-size:20px;font-weight:500;">Kategori</h3>
		<div class="box box-info">
            <div class="box-body">
            	<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Uang <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[1]" value="<?php echo $lang_ids[1]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label"> Cari roduct <span>*</span></label>
                    <div class="col-sm-6">
		...
		<h3 style="font-size:20px;font-weight:500;">Registrasi</h3>
        <div class="box box-info">
            <div class="box-body">
				<div class="form-group">
		...
		<h3 style="font-size:20px;font-weight:500;">Keranjang Dan Checkout</h3>
        <div class="box box-info">
            <div class="box-body">
				<div class="form-group">
        ...
        <div class="box box-info">
            <div class="box-body">				
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label"> Semua Produk<span>*</span></label>
                    <div class="col-sm-6">

        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="user-content">
                    <h3><?php echo "History Order"; ?></h3>
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th><?php echo "Id"; ?></th>
                                    <th><?php echo "Detail Produk"; ?></th>
                                    <th><?php echo "Tanggal dan waktu pembayaran"; ?></th>
                                    <th><?php echo "Bayar"; ?></th>
                                    <th><?php echo "Status Pembayaran"; ?></th>
                                    <th><?php echo "Status Pengiriman"; ?></th>
                                    <th><?php echo "Pembayaran"; ?></th>
                                    <th><?php echo "Id pembayaran"; ?></th>
                                </tr>
                            </thead>
                            <tbody>
            ...
            ?>
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo "Rp."?><?php echo $row['paid_amount']; ?><?php echo ".000"?></td>

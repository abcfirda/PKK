        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="cart">
                    <table class="table table-responsive">
                        <tr>
                            ...
                            <th class="text-right"><?php echo "Harga"; ?></th>
                        </tr>
                         <?php
                        $table_total_price = 0;
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                ?>
                                <?php echo LANG_VALUE_1; ?><?php echo $row_total_price; ?><?php echo ".000"; ?>
                            </td>
                        </tr>
                        <?php endfor; ?>           
                        <tr>
                            <th colspan="5" class="total-text"><?php echo "Harga"; ?></th>
                            <th class="total-amount"><?php echo "Rp"; ?><?php echo $table_total_price; ?><?php echo ".000"; ?></th>
                        </tr>
                         ...
                         <tr>
                            ...
                            <th class="total-amount">
                                ...
                                ?>
                                <?php echo "Rp"; ?><?php echo $final_total; ?><?php echo ".000"; ?>
                            </th>
                        </tr>
                    </table> 
                </div>
                ...
                <div class="billing-address">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="special"><?php echo Alamat ?></h3>
                        ...
                        <div class="col-md-6">
                            <h3 class="special"><?php echo "Alamat Pengiriman"; ?></h3>
                            <table class="table table-responsive table-bordered bill-address">
                                <tr>
                                    <td><?php echo "Nama" ?></td>
                                ...
                                <tr>
                                    <td><?php echo "Nama panjang"; ?></td>
                                    <td><?php echo $_SESSION['customer']['cust_s_cname']; ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo "Telepone"; ?></td>
		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
				                <div style="color:red;font-size:22px;margin-bottom:50px;">
			                        Pilih produk  <a href="customer-profile-update.php" style="color:red;text-decoration:underline;">Update alamat</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
                                ...
                                <form action="payment_success.php" method="post">
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
	                                        ...
	                                        <option value="J&T"><?php echo LANG_VALUE_38; ?></option>
	                                    </select>
